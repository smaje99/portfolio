...
Este documento contiene copy preparado para publicar manualmente en GitHub y LinkedIn. Las plataformas conservan funciones distintas: GitHub prioriza señales técnicas y legibilidad para desarrolladores; LinkedIn prioriza trayectoria profesional, contexto laboral y formación. La adaptación no debe cambiar el alcance de las afirmaciones.

## Mensaje común

* **Identidad:** desarrollador de software.
* **Foco:** backend, datos y sistemas de información.
* **Forma de trabajo:** conectar procesos, requisitos, datos y decisiones de desarrollo.
* **Valor comunicado:** construir soluciones digitales claras, mantenibles y útiles.
* **Contexto profesional actual:** desarrollador de software en el Centro de Desarrollo Tecnológico para la Transformación Digital y la Industria 4.0 — Cidti 4.0, jornada parcial, desde marzo de 2026.
* **Estado académico:** formación académica finalizada en Ingeniería Informática; grado en trámite.
* **Formación complementaria:** BPM y Analítica de Datos.

No se utilizan `student`, `experto`, `especialista`, `senior`, `líder técnico`, `consultor`, `end-to-end` ni promesas de resultados. Los proyectos públicos deben seguir presentándose como evidencia contextual hasta que exista una ficha de caso de estudio aprobada.

## GitHub — versión para desarrolladores
...
```text
Software developer focused on backend, data, and information systems. Building clear, maintainable digital solutions.
```
...
## Software Developer · Backend · Data · Information Systems

I am a software developer focused on backend, data, and information systems. I connect processes, requirements, data, and development decisions to build clear, maintainable, and useful digital solutions.

Currently, I work part-time as a Software Developer at Centro de Desarrollo Tecnológico para la Transformación Digital y la Industria 4.0 (Cidti 4.0).

### What I work on

- Backend development and modular software architectures
- Information extraction, processing, and data integration
- Requirements analysis and process-oriented software design
- Systems that connect operations, data, and application development
- Technical documentation and tools for learning and collaboration
...
```text
Soy desarrollador de software orientado a backend y datos, con formación académica finalizada en Ingeniería Informática y grado en trámite.

Actualmente trabajo como desarrollador de software, en jornada parcial, en el Centro de Desarrollo Tecnológico para la Transformación Digital y la Industria 4.0 (Cidti 4.0). Mi trabajo conecta requisitos, procesos, datos y decisiones de desarrollo para contribuir a soluciones digitales claras, mantenibles y útiles.
...
* **Organización:** `Centro de Desarrollo Tecnológico para la Transformación Digital y la Industria 4.0 — Cidti 4.0`
* **Periodo:** `marzo de 2026 — actualidad`
* **Modalidad:** `Jornada parcial · Cali, Valle del Cauca, Colombia · En remoto`

La captura de LinkedIn recibida el 2026-08-31 confirma este cargo y resuelve la incertidumbre previa sobre la experiencia actual. Esta experiencia ya fue incorporada a las fuentes LaTeX y publicada en los tres PDFs mediante `make cv`.

### Educación que debe conservarse

* **Institución:** `Fundación Universitaria Internacional de La Rioja — UNIR`
* **Programa:** `Ingeniería Informática`
* **Estado:** `Formación académica finalizada. Grado en trámite.`
* **Año mostrado:** `2026`

La captura de Educación recibida el 2026-08-31 confirma el estado académico aprobado para el Sprint 04. El texto del apartado Acerca de debe dejar de decir `Soy estudiante` para mantener la misma semántica.

## Trazabilidad con Sprint 04
