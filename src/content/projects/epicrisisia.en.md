...
Sergio refactored and redesigned the application, defined its architecture, integrated LLMs and RAG, improved the workflow, added deterministic tools, and aligned the experience with the company design system, including accessibility and integrated UX flows. The initial core and base flow were built by another contracted developer, with the technical lead participating in the original design.
